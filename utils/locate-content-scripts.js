// https://github.com/ymdevs/Web-Extension-Starter/blob/master/utils/locateContentScripts.js
...
const findContentEntryFile = (contentPath) => {
  ...
  if (!files || files.length < 1) {
    ...
    throw new Error(
      `Found ${files.length} index files, ${files}, in path:\n${contentPath}\nOnly one should be set.\n`
    );
  }
};
 ...
 * @returns T[] A list of objects containing path and folder name
 */
